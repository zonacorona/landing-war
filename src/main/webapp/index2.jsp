...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://7d69c24efa79ed2429e6-1e1c5ac10380ee72a01b057764b93d72.ssl.cf1.rackcdn.com/mine.css"/>
...
<div id="main-content">
  <div class="container" id="container" style="width: 960px;">
    ...
    </c:forEach><%-- End of outter most Object wich is a ProductCategory: ${bean.categorizedProducts} --%>
